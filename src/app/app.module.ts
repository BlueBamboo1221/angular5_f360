...
import { OnboardingPartnerMerchantsComponent } from './pages/partners/onboarding-partner/onboarding-partner-merchants/onboarding-partner-merchants.component'; //rki_add
...
import { MerchantService } from './pages/partners/onboarding-partner/onboarding-partner-merchants/service/merchant.service'; //rki_add
...
const innerOnboardingPartner: Routes = [
  ...
  { path: 'merchants', component: OnboardingPartnerMerchantsComponent } //rki_add
];
...
@NgModule({
  declarations: [
    ...
    OnboardingPartnerMerchantsComponent, //rki_add
